...
<%
    ...
    try {
        ...
        sql = "INSERT INTO board_file_detail (file_id, file_real_nm, file_origin_nm, file_extention, file_size ,file_thumbnail_nm ) VALUES (?, ?, ?, '', 0 , ?)";
        psmt = conn.prepareStatement(sql);
        ...
        sql = "INSERT INTO board(title, content, type, file_id, created_ip, created_by, created_at, modified_by, modified_ip, modified_at) VALUES(?, ?, 'S', ?, ?, ?, now(), ?, 'TEST', now())";
        psmt = conn.prepareStatement(sql);
